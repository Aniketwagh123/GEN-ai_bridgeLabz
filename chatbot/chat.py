...
def get_webpage_text(urls):
    ...
    for url in urls:
        ...
        # Extract text from webpage body
...
def main():
    ...
    user_question = st.text_input(
        "Ask a Question from the PDF Files or Webpages")
    ...
    with st.sidebar:
        ...
        webpage_urls = st.text_area(
            "Enter Webpage URLs (one per line)").splitlines()
        ...
        if st.button("Submit & Process"):
            with st.spinner("Processing..."):
                ...
                # Process Webpages
                if webpage_urls:
                    raw_text += get_webpage_text(webpage_urls)
